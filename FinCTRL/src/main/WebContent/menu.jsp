...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <a class="navbar-brand" href="home.jsp">FinCTRL</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item">
        <a class="nav-link" href="produto?acao=abrir-form-cadastro">Cadastrar Despesas</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="produto?acao=listar">Meus Gastos</a>
      </li>
    </ul>
